...
# print("\nУпрощённая первая производная:", sp.simplify(dy1))
# print("Упрощённая вторая производная:", sp.simplify(dy2))
...
# dx = (b - a) / n
#
# integral_rect = np.sum(f(x[:-1]) * dx)
#
# print(f"Integral solved by the left rectangle method from {a} to {b}: {integral_rect}")
